...
gulp.task('build:html', ['clean:html'], function() {
    ...
    // }))
		.pipe(copyPublic(""));
    // .pipe(copyPublic("styleguide/html"));
});
...
gulp.task('serve:prod', function(cb) {
	runSequence(['build:js-prod', 'watch:prod', 'build:html', 'build:css-patternlab'], cb);
});
...
gulp.task('default', ['build:css-patternlab', 'build:html', 'build:js-pattern'], function () {
